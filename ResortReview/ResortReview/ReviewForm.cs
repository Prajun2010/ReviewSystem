    ...
    public partial class ReviewForm : Form
    {
        ...
        private void SubmitBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Regex emailValidation = new Regex("^[a-zA-Z0-9]+@([-a-zA-Z0-9]+[.])+[a-zA-Z]{2,5}$");
                if (!emailValidation.IsMatch(customerEmailBox.Text))
                {
        ...
        private void SaveFeedback()
        {
            ...
            cr.RatingTime = DateTime.Now;
            string response = cr.SaveReview(cr);

            //clearing out previous feedbacks and reviews
            if (response == "Success")
            {
